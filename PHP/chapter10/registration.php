...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
  ...
  <table>
    <tr>
      ...
      <td><input id="firstname" name="firstname" type="text" value="<?php if(!empty($first_name)) echo $first_name; ?>"/></td></tr>
    <tr>
      <td><label for="lastname">Last Name:</label></td>
      <td><input id="lastname" name="lastname" type="text" value="<?php if(!empty($last_name)) echo $last_name; ?>"/></td></tr>
    <tr>
